...
<div class="mb-4 flex items-center justify-between">
  {#if selectedFaculty}
    <div class="mb-4 rounded bg-gray-100 p-3 text-base text-gray-700">
      ...
      <span>{selectedFaculty.highest_degree ?? '-'}{selectedFaculty.highest_degree_year ? `(${selectedFaculty.highest_degree_year})` : ''}</span>
    </div>
...
<table class="w-full border-collapse border text-sm">
  <thead>
    <tr class="bg-gray-200">
      <th class="w-20 border p-2">Type</th>
      ...
      <th class="w-50 border p-2 break-words whitespace-normal">Types of Intellectual<br>Contributions</th>
